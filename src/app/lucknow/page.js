...
export default function LucknowPage() {
  const areas = [
    {
      name: 'Gomti Nagar',
      description: 'Premium laundry service for Gomti Nagar residents and corporate offices.',
      image: '/ln2.jpeg'
    },
    {
      name: 'Hazratganj',
      description: 'Professional laundry service for Hazratganj area and nearby localities.',
      image: '/ln3.jpeg'
    },
    {
      name: 'Aliganj',
      description: 'Reliable laundry service for Aliganj and surrounding residential areas.',
      image: '/ln4.jpeg'
    },
    {
      name: 'Indira Nagar',
      description: 'Quality laundry service for Indira Nagar and nearby areas.',
      image: '/ln5.jpg'
    }
  ];
  ...
  return (
    <div className="min-h-screen py-12 font-lora bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <div className="relative h-80 mb-16">
        ...
        <Image
          src="/laund2.jpg"
          alt="Laundry Services in Lucknow"
          fill
          priority
      ...
      <div className="container-custom mt-16">
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-3xl font-bold mb-4">Ready to Experience Premium Laundry Service in Lucknow?</h2>
