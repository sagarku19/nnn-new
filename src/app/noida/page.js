...
export default function NoidaPage() {
  const areas = [
    {
      name: 'Sector 62',
      description: 'Premium laundry service for Sector 62 residents and corporate offices.',
      image: '/ln2.jpeg'
    },
    {
      name: 'Sector 18',
      description: 'Professional laundry service for Sector 18 and nearby commercial areas.',
      image: '/ln3.jpeg'
    },
    {
      name: 'Sector 137',
      description: 'Reliable laundry service for Sector 137 and surrounding residential areas.',
      image: '/ln4.jpeg'
    },
    {
      name: 'Sector 168',
      description: 'Quality laundry service for Sector 168 and nearby areas.',
      image: '/ln5.jpg'
    }
  ];
      ...
      <div className="container-custom mt-16">
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-3xl font-bold mb-4">Ready to Experience Premium Laundry Service in Noida?</h2>
