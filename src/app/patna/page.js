...
export default function PatnaPage() {
  const areas = [
    {
      name: 'Boring Road',
      description: 'Premium laundry service for Boring Road residents and commercial areas.',
      image: '/ln2.jpeg'
    },
    {
      name: 'Kankarbagh',
      description: 'Professional laundry service for Kankarbagh and nearby localities.',
      image: '/ln3.jpeg'
    },
    {
      name: 'Patliputra',
      description: 'Reliable laundry service for Patliputra and surrounding residential areas.',
      image: '/ln4.jpeg'
    },
    {
      name: 'Bailey Road',
      description: 'Quality laundry service for Bailey Road and nearby areas.',
      image: '/ln5.jpg'
    }
  ];
      ...
      <div className="container-custom mt-16">
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-3xl font-bold mb-4">Ready to Experience Premium Laundry Service in Patna?</h2>
